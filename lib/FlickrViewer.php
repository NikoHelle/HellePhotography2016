...
class FlickrViewer
{
   ...
   public function getSetId($flickrId){
    ...
    public function saveSetData($flickrId,$name,$hash=false,$status=false,$type=false,$view_rights=0,$download_rights=0,$expires=false){
		...
		/*
		id	int(10)	No 	 	 
		flickr_id	varchar(100)	No 	 	 
		name	varchar(100)	No 	 	 
		hash	varchar(32)	No 	 	 
		view_rights	int(10)	No 	 	 
		download_rights	int(10)	No 	 	 
expires
		*/
	}
   ...
   public function savePhotoData($setId,$photo,$originalSecret,$sizes){
		...
		id	int(10)	No 	 	 
		set_id	int(10)	No 	 	 
		image_id	varchar(50)	No 	 	 
		secret	varchar(50)	No 	 	 
		server_id	varchar(10)	No 	 	 
		farm_id	varchar(5)	No 	 
		original_width,
		original_height	 
		size_ratio	decimal(10,8)	No 	 	 
		sizes	varchar(200)	No 	 	 
		views	mediumint(9)	No 	0 	 
		likes	smallint(5)	No 	0 	 
		shares	smallint(5)	No 	0 	 
		buys	smallint(5)	No 	0 	 
		ext_link	varchar(200)	Yes 	NULL 	 
		update_info	varchar(1)	No 	 	 
		added
	...
	public function buildSiteMap(){
		...
		/*$map["selector"] = "#frontpage";
		$map["properties"] = array();
		$map["properties"]["data"] = array();
		$map["properties"]["data"]["type"] = "frontpage";
		$map["properties"]["data"]["id"] = "";
		$map["subpages"] = array();*/
	...
	public function buildSetMap($setId){
		...
		/*$set["selector"] = "#set-".$setId;
		$set["properties"] = array();
		$set["properties"]["data"] = array();
		$set["properties"]["data"]["type"] = "set";
		$set["properties"]["data"]["id"] = $setId;
		$set["subpages"] = array();*/
	...
	public function buildPhotoMap($photoId){
		...
		/*$photo = array();
		$photo["selector"] = "#photo-".$photoId;
		$photo["properties"] = array();
		$photo["properties"]["data"] = array();
		$photo["properties"]["data"]["type"] = "photo";
		$photo["properties"]["data"]["id"] = $photoId;*/
		
		/*$set["subpages"] = array();
		$photos = $this->getDBSetPhotos($setId,"views","DESC",FlickrPhotoHA::STATUS_OK);
		foreach($photos as $photo){
			$photoData =$this->buildPhotoMap($photo["id"]);
			array_push($set["subpages"],$photoData);
